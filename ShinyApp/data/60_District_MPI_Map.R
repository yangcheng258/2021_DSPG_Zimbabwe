...
M0_labels <- get_label(Dist_60_Map@data$NAME_2, "M<sub>0</sub>", M0, switch(k_threshold,
...
M1_labels <- get_label(Dist_60_Map@data$NAME_2, "M<sub>1</sub>", M1, switch(k_threshold,
...
M2_labels <- get_label(Dist_60_Map@data$NAME_2, "M<sub>2</sub>", M2, switch(k_threshold,
